package com.example.borutoapp.feature_hero.data.paging_source
...
class HeroRemoteMediator @Inject constructor(
    ...
    override suspend fun initialize(): InitializeAction {
        ...
        Log.d("RemoteMediator", "Current time is ${parseMillis(currentTime)}")
        Log.d("RemoteMediator", "Last Updated time is ${parseMillis(lastUpdated)}")
